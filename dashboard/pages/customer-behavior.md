...
- **Type:** Card
- **Measure:** [Valid Customers](../reference/measures-and-calculated-columns.md#valid-customers)
...
- **Type:** Card
- **Measure:** [Lifetime Repeat Customer Rate](../reference/measures-and-calculated-columns.md#lifetime-repeat-customer-rate)
...
- **Type:** Card
- **Measure:** [Average Orders per Customer](../reference/measures-and-calculated-columns.md#average-orders-per-customer)
...
- **Display Name:** AOV
- **Type:** Card
- **Measure:** [AOV](../reference/measures-and-calculated-columns.md#aov)
...
- **Type:** Card
- **Measure:** [GMV per Customer](../reference/measures-and-calculated-columns.md#gmv-per-customer)
...
- **Type:** Card
- **Measure:** [Revenue from Repeat Customers %](../reference/measures-and-calculated-columns.md#revenue-from-repeat-customers-percent)
...
- **Type:** Card
- **Measure:** [Top 10% Customers GMV Share](../reference/measures-and-calculated-columns.md#top-10-percent-customers-gmv-share)
...
- **Type:** Card
- **Measure:** [Top 10% Customer Count](../reference/measures-and-calculated-columns.md#top-10-percent-customer-count)
...
- **Measure:** [Customer Share %](../reference/measures-and-calculated-columns.md#customer-share-percent)
...
- **Type:** Horizontal bar chart
- **Axis:** [`orders_final[Customer Segment]`](../reference/measures-and-calculated-columns.md#orders-final-customer-segment)
- **Measure:** [Net GMV](../reference/measures-and-calculated-columns.md#net-gmv)
...
- **Measure:** [Returning Customer Rate](../reference/measures-and-calculated-columns.md#returning-customer-rate)
...
- **Measure:** [GMV per Customer](../reference/measures-and-calculated-columns.md#gmv-per-customer)
- **Tooltip:** [Valid Customers](../reference/measures-and-calculated-columns.md#valid-customers)
