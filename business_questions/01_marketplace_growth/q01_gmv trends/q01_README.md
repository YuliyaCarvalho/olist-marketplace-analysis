...
GMV was calculated as the **sum of valid payment values for orders with a final status of `delivered`**.
...
**Financial noise reduction**

Payments below **1 BRL** and zero-value payments were removed because they typically represent vouchers or technical artifacts rather than genuine purchases.
